        ...
        <div class="page-content">
            ...
            ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md">
                                        <div class="form-group">
                                            ...
                                            <input name="min_support" type="text" value="<?php echo $_POST['min_support']; ?>" class="form-control" placeholder="Nilai Min Support">
                                        </div>
                                        <div class="form-group">
                                            <label>Min Confidence: </label>
                                            <input name="min_confidence" type="text" value="<?php echo $_POST['min_confidence']; ?>" class="form-control" placeholder="Nilai Min Confidence">
                                        </div>
                ...
                <?php
                    ...
                    echo "Nilai Min Support Relatif: " . $minSupportRelatif;
                    echo "<br>";
                    echo "Nilai Min Confidence: " . $_POST['min_confidence'];
                    echo "<br>";
                ...
                <form method="post" action="">
                    <div class="row">
                        ...
                        <div class="col-lg-6 ">
                            ...
                            <div class="form-group">
                                <input name="min_confidence" type="text" class="form-control" placeholder="Nilai Min Confidence">
                            </div>
                            <div class="form-group">
                                <input name="submit" type="submit" value="Proses" class="btn btn-success">
                            </div>
